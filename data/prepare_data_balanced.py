...
class BalancedDataPreparator:
    ...
    def needs_recreation(self, force_recreate: bool = False) -> bool:
        ...
        required_files = [
            ...
            self.data_dir / "processed_dataset_balanced",
            self.data_dir / "metadata_balanced.json"
        ]
        ...
        config_hash_file = self.data_dir / "config_hash_balanced.txt"
    ...
    def create_balanced_dataset(self) -> Tuple[DatasetDict, Dict]:
        ...
        metadata_path = self.data_dir / "metadata_balanced.json"
        ...
        self.logger.info(f"Balanced dataset created and saved to {dataset_path}")
