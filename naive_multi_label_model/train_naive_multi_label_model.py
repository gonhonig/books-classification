...
class NeuralNetworkTrainer:
    ...
    def load_data(self):
        ...
        train_labels = np.array(self.dataset['train']['naive_labels'], dtype=np.float32)
        val_labels = np.array(self.dataset['validation']['naive_labels'], dtype=np.float32)
        test_labels = np.array(self.dataset['test']['naive_labels'], dtype=np.float32)
    ...
    def train_model(self, epochs=None, batch_size=None, learning_rate=None, patience=None, weight_decay=None):
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                patience_counter = 0
                # Save best model
                torch.save(self.model.state_dict(), 'naive_multi_label_model/best_neural_network.pth')
            else:
                patience_counter += 1
        ...
        # Load best model
        self.model.load_state_dict(torch.load('naive_multi_label_model/best_neural_network.pth'))
    ...
    def calculate_per_book_metrics(self):
        ...
        metrics_path = "naive_multi_label_model/naive_multi_label_detailed_metrics.json"
        with open(metrics_path, 'w') as f:
            json.dump(per_book_metrics, f, indent=2)
        
        # Create detailed report
        report_path = "naive_multi_label_model/naive_multi_label_detailed_metrics_report.md"
    ...
    def extract_test_examples(self):
        ...
        # Save examples
        examples_path = "naive_multi_label_model/naive_multi_label_test_examples.json"
        with open(examples_path, 'w') as f:
            json.dump(examples, f, indent=2)
        
        # Create detailed report
        report_path = "naive_multi_label_model/naive_multi_label_test_examples_report.md"
        with open(report_path, 'w') as f:
    ...
    def save_model(self):
        ...
        models_dir = Path("naive_multi_label_model")
